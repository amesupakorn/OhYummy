...
<html lang="en">
  ...
  >
    ...
    <div class="content" style="height: 30px"></div>
        <h3>เวลา</h3><hr />
        <div class="time-slot" onclick="selectTime(this)" value="10">10:00</div>
        <div class="time-slot" onclick="selectTime(this)" value="11">11:00</div>
        <div class="time-slot" onclick="selectTime(this)" value="12">12:00</div>
        <div class="time-slot" onclick="selectTime(this)" value="13">13:00</div>
        <div class="time-slot" onclick="selectTime(this)" value="14">14:00</div>
        <div class="time-slot" onclick="selectTime(this)" value="15">15:00</div>
        <div class="time-slot" onclick="selectTime(this)" value="16">16:00</div>
        <div class="time-slot" onclick="selectTime(this)" value="17">17:00</div>
        <div class="time-slot" onclick="selectTime(this)" value="18">18:00</div>
        <div class="time-slot" onclick="selectTime(this)" value="19">19:00</div>
        <div class="time-slot" onclick="selectTime(this)" value="20">20:00</div>
      </div>
    </div><br>
