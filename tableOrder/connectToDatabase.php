...
class database{
    ...
    public function addRowJSON($tableName, $jsonColumn, $jsonData) {
        $sql = "INSERT INTO `$tableName` (`$jsonColumn`) VALUES ('$jsonData')";
        if ($this->database->query($sql) === TRUE) {
            echo "Record added successfully";
        } else {
            echo "Error adding record: " . $this->database->error;
        }
    }
}
